...
void EXTI0_IRQHandler(void)
{
  ...
  gmr_encoder_update(ENCODER_1);
  /* USER CODE END EXTI0_IRQn 0 */
  HAL_GPIO_EXTI_IRQHandler(ENCODER_A1_Pin);
...
void EXTI2_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(ENCODER_B1_Pin);
...
void EXTI9_5_IRQHandler(void)
{
  ...
  gmr_encoder_update(ENCODER_2);
  /* USER CODE END EXTI9_5_IRQn 0 */
  HAL_GPIO_EXTI_IRQHandler(ENCODER_B2_Pin);
